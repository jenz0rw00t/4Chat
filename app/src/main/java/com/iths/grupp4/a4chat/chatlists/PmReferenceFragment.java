...
public class PmReferenceFragment extends Fragment implements
    ...
    private static final String TAG = "PmReferenceFragment";
    ...
    private void openChangePhotoDialog(View view) {
        ...
        dialog.setTargetFragment(PmReferenceFragment.this, 1);
