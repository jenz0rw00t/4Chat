...
public class MainActivity extends AppCompatActivity implements IMainActivity{
    ...
    public static String getCameraPositionBack() {
        return CAMERA_POSITION_BACK;
    }

    public static void setCameraPositionBack(String cameraPositionBack) {
        CAMERA_POSITION_BACK = cameraPositionBack;
    }
...
// no camera on this device
    ...
    public void setCameraBackFacing() {
        ...
        mCameraOrientation = getCameraPositionBack();
    }
    ...
    public void setBackCameraId(String cameraId){
        setCameraPositionBack(cameraId);
    }
    ...
    public boolean isCameraBackFacing() {
        return mCameraOrientation.equals(getCameraPositionBack());
    }

    @Override
    public String getBackCameraId(){
        return getCameraPositionBack();
    }
